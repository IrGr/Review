<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="RetTilbud.aspx.cs" Inherits="Admin_RetTilbud" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>Redigere tilbud</h2>
    <hr />
    <!--Produkter-->
    ...
    <asp:Button ID="Button_GemTilbud" runat="server"
        class="col-md-2 col-md-offset-3" OnClick="Button_GemTilbud_Click"
